...
| -------------- | -------------- | ---------------------- |
| Ethernet6 | - | internet_path-RR1-Ethernet3<br>internet_path-RR2-Ethernet3 |
...
| Ethernet5 | - | mpls_path-RR1-Ethernet2<br>mpls_path-RR2-Ethernet2 |
...
| ----------- | ----------- | ------------ | ------------- | ---------------------- | ---------------- |
| LB-DEFAULT-AVT-POLICY-DEFAULT | - | - | - | mpls_path (1) | False |
