...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.99.98.14/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | mpls | routed | - | 192.25.77.2/24 | default | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.99.99.14/32 |
...
| --- | ------------------- | ------------ |
| default | 10.99.99.14:1 | - |
| VRF_A | 10.99.99.14:101 | connected |
...
!
router bgp 65000
   router-id 10.99.99.14
   maximum-paths 16
   no bgp default ipv4-unicast
   bgp cluster-id 10.99.99.14
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.99.99.14:0 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.99.99.14:0 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.99.99.14:0 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.99.99.14:0
```
...
| Name | Prefixes |
| ---- | -------- |
| PFX-LOCAL-VTEP-IP | 10.99.98.14/32 |
...
| LB-DEFAULT-POLICY-CONTROL-PLANE | - | - | - | internet_path (1)<br>LAN_HA (1)<br>mpls_path (1) | False |
| LB-DEFAULT-POLICY-DEFAULT | - | - | - | internet_path (1)<br>LAN_HA (1)<br>mpls_path (1) | False |
