...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.99.98.11/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.99.99.11/32 |
...
| --- | ------------------- | ------------ |
| default | 10.99.99.11:101 | - |
| VRF_A | 10.99.99.11:102 | connected |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.99.99.11:0 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.99.99.11:0 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.99.99.11:0 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.99.99.11:0
```
...
| Name | Prefixes |
| ---- | -------- |
| PFX-LOCAL-VTEP-IP | 10.99.98.11/32 |
